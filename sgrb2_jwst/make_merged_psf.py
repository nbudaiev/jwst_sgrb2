#Copied from https://github.com/keflavich/brick-jwst-2221/blob/main/brick2221/reduction/make_merged_psf.py Mar 03 2026
...
os.environ['WEBBPSF_PATH'] = '/orange/adamginsburg/jwst/sgrb2/NB/webbpsf-data/'
...
def make_merged_psf(filtername, basepath, halfstampsize=25,
                    ...
                    smoothing_scales={'f182m': 0.25, 'f187n':0.25, 'f212n':0.55, 'f200w': 0.55, 'f115w': 0.25,
                                      ...
                                      'f150w': 0.25, 'f300m': 0.55, 'f360m': 0.55, 'f480m': 0.55},
                    project_id='3565', obs_id='001', suffix='merged_i2d'):
    """
...
if __name__ == "__main__":
    ...
    parser.add_option("-f", "--filternames", dest="filternames",
                    ...
                    default='F480M,F466N,F410M,F405N,F360M,F300M,F212N,F210M,F187N,F182M,F150W',
    ...
    obs_filters = {'2221': ['F410M', 'F212N', 'F466N', 'F405N', 'F187N', 'F182M'],
                   ...
                   '5365': ['F480M', 'F466N', 'F410M', 'F405N', 'F360M', 'F300M', 'F212N', 'F210M', 'F187N', 'F182M', 'F150W']
                  }
    ...
    basepath = f'/orange/adamginsburg/jwst/{target}/NB/'
